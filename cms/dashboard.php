...
// ---------------FILE UPLOAD EXAMPLE ------------------
//inicijalizacija varijable u slucaju da se ne uploada nista
...
<h5 style="color:#00e3ff">Added static method: <b> html_handler::import_lib("example.css");</b> for including libraries
    . all libraries must be in the js or css folder <b>WORKS WITH JS AND CSS</b> </h5>
...
<h5 style="color:#00e8ff"> Build header static function must be right before closing first ?> php script cause other
    headers wont work</h5>
<h5 style="color:#00e3ff">html_handler::import_lib(""); method must be after the build header function !!!!!!!!!!!!!
</h5>
<hr>
<hr>
<h3 style="color: #a30000;">##############################____CORE UPDATE
    25/5/2019______###################################</h3>
<hr>
<h5 style="color:#00e3ff"> Dodana static metoda za upload fileova . Metoda prima 1 file ili listu fileova. </h5>
<h5 style="color:#00e3ff"> Ispod imate formu koja prima listu fileova i mozete je kopirat. obratite na enctype i arraj
    name="files[]" i atribut multiple. to omogucava vise fileova </h5>
<h5 style="color:#00e3ff">
    Obratite pozornost na echo "<>".$file_upload_return_message."<>" koji ispisuje erore ili successove ako se fileovi
            uploadaju.
